const Locale = (function () {
  const S = {
    ko: {
      'sub':         '이미지 한 장을 정확한 격자로 재단해\n원 UI 빠른 설정 패널에 맞춰드립니다.',
      'note':        'GoodLock QuickStar용 One UI 패널 재단 도구',
      'ba.before':   'RAW',
      'ba.after':    'CUT',
      'launch':      '시작하기',
      'p1.title':    '격자 설정',
      'p1.desc':     '패널 크기를 정하고, 버튼이 들어갈 영역을 드래그로 지정하세요.',
      'p1.rows':     '세로',
      'p1.cols':     '가로',
      'p1.more':     '직접 입력',
      'p1.make':     '만들기',
      'p1.clear':    '초기화',
      'p1.hint':     '드래그로 영역을 지정하고, 지정된 영역을 다시 클릭하면 해제됩니다.',
      'p2.title':    '이미지 불러오기',
      'p2.desc':     '재단할 이미지를 불러오세요.',
      'p2.drop':     '이미지를 드래그하거나',
      'p2.browse':   '파일 선택',
      'p2.paste':    '또는 Ctrl+V로 붙여넣기',
      'p3.title':    '재단 영역 선택',
      'p3.desc':     '격자 비율에 맞춰 재단할 영역을 지정하세요.',
      'p3.cut':      '재단 & 계속',
      'p4.title':    '재단 결과',
      'p4.desc':     '결과를 확인하고 ZIP으로 저장하세요.',
      'p4.map':      '재단 지도',
      'p4.pick':     '타일 종류',
      'p4.pickbody': '<strong>버튼 박스 · 미디어 · 밝기 · 볼륨</strong> 타일을 표시하세요. 투명 처리에 사용됩니다.',
      'p4.caution':  '미디어 플레이어는 재생 중 이미지가 가려지므로 권장하지 않습니다. 버튼 박스는 확장 시 이미지도 함께 늘어날 수 있습니다.',
      'p4.guide':    '적용하기',
      'p4.guidebody':'ZIP 압축을 해제한 뒤 <strong>GoodLock → QuickStar → 패널 스타일 편집</strong>에서 타일마다 이미지를 지정하세요.',
      'go':          '다음',
      'back':        '이전',
      'home':        '처음으로',
      'save':        'ZIP 저장',
    ...
    en: {
      'sub':         'Cut one image into a precise grid,\nregistered to the One UI Quick Settings panel.',
      'note':        'A One UI panel cutting tool for GoodLock QuickStar',
      'ba.before':   'RAW',
      'ba.after':    'CUT',
      'launch':      'Get started',
      'p1.title':    'Set the grid',
      'p1.desc':     'Set the panel size, then drag to mark each button region.',
      'p1.rows':     'Rows',
      'p1.cols':     'Cols',
      'p1.more':     'Custom',
      'p1.make':     'Build',
      'p1.clear':    'Clear',
      'p1.hint':     'Drag to mark a region. Click a marked region again to remove it.',
      'p2.title':    'Load image',
      'p2.desc':     'Load the image you want to cut.',
      'p2.drop':     'Drop image here, or',
      'p2.browse':   'Browse file',
      'p2.paste':    'or paste with Ctrl+V',
      'p3.title':    'Set cut area',
      'p3.desc':     'Fit the crop to your grid ratio.',
      'p3.cut':      'Cut & continue',
      'p4.title':    'Cut result',
      'p4.desc':     'Review the tiles and save them as a ZIP.',
      'p4.map':      'Cut map',
      'p4.pick':     'Tile types',
      'p4.pickbody': 'Mark tiles for <strong>Button box · Media · Brightness · Volume</strong>. Used for transparency handling.',
      'p4.caution':  "Media player tiles aren't recommended — the image won't show during playback. Button boxes may stretch the image when expanded.",
      'p4.guide':    'Apply on device',
      'p4.guidebody':'Unzip the file, then open <strong>GoodLock → QuickStar → Edit Panel Style</strong> and set each tile\'s image.',
      'go':          'Next',
      'back':        'Back',
      'home':        'Start over',
      'save':        'Save ZIP',
    ...
    ja: {
      'sub':         '画像1枚を正確なグリッドに裁断し、\nOne UI クイック設定パネルに合わせます。',
      'note':        'GoodLock QuickStar向け One UI パネル裁断ツール',
      'ba.before':   'RAW',
      'ba.after':    'CUT',
      'launch':      'はじめる',
      'p1.title':    'グリッド設定',
      'p1.desc':     'パネルサイズを決め、ボタンが入る領域をドラッグで指定してください。',
      'p1.rows':     '縦',
      'p1.cols':     '横',
      'p1.more':     'カスタム',
      'p1.make':     '作成',
      'p1.clear':    'リセット',
      'p1.hint':     'ドラッグで領域を指定。指定済みの領域は再クリックで解除されます。',
      'p2.title':    '画像を読み込む',
      'p2.desc':     '裁断する画像を読み込んでください。',
      'p2.drop':     '画像をドロップ、または',
      'p2.browse':   'ファイル選択',
      ...
      'p3.cut':      '裁断して続ける',
      'p4.title':    '裁断結果',
      'p4.desc':     '結果を確認し、ZIPで保存してください。',
      'p4.map':      '裁断マップ',
      'p4.pick':     'タイル種別',
      'p4.pickbody': '<strong>ボタンボックス · メディア · 輝度 · 音量</strong>にあたるタイルを指定してください。透明処理に使用します。',
      'p4.caution':  'メディアプレーヤーは再生中に画像が隠れるため非推奨です。ボタンボックスは展開時に画像も伸びる場合があります。',
      'p4.guide':    '端末での適用',
      'p4.guidebody':'ZIPを解凍し、<strong>GoodLock → QuickStar → パネルスタイル編集</strong>で各タイルに画像を指定してください。',
      'go':          '次へ',
      'back':        '戻る',
      'home':        '最初から',
      'save':        'ZIP保存',
...
const Cropper = (function(){
  ...
  function applyDrag(mx,my){
    ...
    // keep the frame fully inside the source image — never let it
    // extend past the canvas bounds, in either size or position.
